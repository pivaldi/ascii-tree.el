...
(ert-deftest ascii-tree-export--format-content-paragraph ()
             ...
             (with-temp-buffer
               ...
               (let* ((tree (org-element-parse-buffer))
                      ...
                      (lines (ascii-tree-export--format-content para '(nil) (current-buffer))))
...
(ert-deftest ascii-tree-export--format-content-plain-list ()
             ...
             (with-temp-buffer
               ...
               (let* ((tree  (org-element-parse-buffer))
                      ...
                      (lines (ascii-tree-export--format-content plist '(nil) (current-buffer))))
...
(ert-deftest ascii-tree-export--walk-integration ()
             ...
             (with-temp-buffer
               ...
               (let* ((tree   (org-element-parse-buffer))
                 ...
                 (ascii-tree-export--walk tree '() out src)
...
(ert-deftest ascii-tree-export--multiline-fixed-width ()
...
(ert-deftest ascii-tree-export--multiline-comments ()
